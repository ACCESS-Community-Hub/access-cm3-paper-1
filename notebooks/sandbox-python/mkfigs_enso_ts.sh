...
#PBS -o /g/data/eg3/cxc548/esm16logs_ts
#PBS -e /g/data/eg3/cxc548/esm16logs_ts
...
#make the figures
array=( 03-eq_SST_bias 07-eq_SST_sea_cycle 09-ENSO_pattern 10-ENSO_lifecycle 11-ENSO_amplitude 12-ENSO_seasonality 13-ENSO_asymmetry 14-ENSO_duration 15-ENSO_diversity)
