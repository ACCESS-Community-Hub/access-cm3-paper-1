...
Adapted from access-om3-paper-1's notebooks/mkfigs_bootstrap.py: these
notebooks live one directory deeper (notebooks/polished-python/), so the
walk up to the repo root needs one extra .parent.

Remove this file, and the `import mkfigs_bootstrap` line in each notebook's
bootstrap cell, if/when access-model-mkfigs is installed centrally in
access3-26.0x.
"""
import sys
